...
def record_audio_and_save(save_path, n_times=50): #for문에 루프가 도는 것이 n_times
    """
    ...
    for i in range(n_times):
        ...
        sd.wait()
        write("/home/namgabin/voice_recognition/audio_data/"+ save_path+ str(196+i) + ".wav", fs, myrecording)
...
record_audio_and_save("audio_data", n_times=50) # 사니
...
#record_background_sound("background_sound", n_times=100)
 ...
 #step1 after step2 blind
 #step2 after step1 blind
